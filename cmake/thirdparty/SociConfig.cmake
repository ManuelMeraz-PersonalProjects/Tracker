...
if(WIN32)
  ...
  # add check for arm here see http://msdn.microsoft.com/en-
  # us/library/b0084kay.aspx
else(WIN32)
...
if(NOT DEFINED LIB_SUFFIX)
  ...
  set(LIB_SUFFIX ${_lib_suffix}
      CACHE STRING "Specifies suffix for the lib directory")
endif()
  ...
  if("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"
    ...
    if(NOT CMAKE_CXX_COMPILER_VERSION LESS 3.1 AND SOCI_ASAN)
      set(SOCI_GCC_CLANG_COMMON_FLAGS
          "${SOCI_GCC_CLANG_COMMON_FLAGS} -fsanitize=address")
    endif()
    ...
    set(
      CMAKE_CXX_FLAGS
      "${CMAKE_CXX_FLAGS} ${SOCI_GCC_CLANG_COMMON_FLAGS} ${SOCI_CXX_VERSION_FLAGS}"
      )
